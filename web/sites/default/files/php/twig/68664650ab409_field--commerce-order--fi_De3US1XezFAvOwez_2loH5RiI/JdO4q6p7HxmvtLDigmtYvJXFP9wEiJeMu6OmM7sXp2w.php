...
/* themes/custom/dreamland/templates/field/field--commerce-order--field-pdf-file-order--default.html.twig */
class __TwigTemplate_fadb81e230441930feee6b6b78162dbf extends Template
{
  ...
  ";
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 75
                yield "      <div";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 75), "addClass", ["field__item, pdfFile"], "method", false, false, true, 75), 75, $this->source), "html", null, true);
                yield ">
   ";
                // line 76
                $context["file_entity"] = (($__internal_compile_0 = CoreExtension::getAttribute($this->env, $this->source, $context["item"], "content", [], "any", false, false, true, 76)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["#file"] ?? null) : null);
                // line 77
                if ( !(null === ($context["file_entity"] ?? null))) {
                    // line 78
                    yield "    ";
                    // line 79
                    yield "    <a href = \"";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getFileUrl($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["file_entity"] ?? null), "uri", [], "any", false, false, true, 79), "value", [], "any", false, false, true, 79), 79, $this->source)), "html", null, true);
                    yield "\">
<img src =\"/themes/custom/dreamland/images/pdf.png\"></a>
";
                }
                // line 82
                yield "      </div>
...
";
    ...
    {
        return "themes/custom/dreamland/templates/field/field--commerce-order--field-pdf-file-order--default.html.twig";
    }
    ...
    {
        return array (  159 => 87,  155 => 85,  152 => 84,  145 => 82,  138 => 79,  136 => 78,  134 => 77,  132 => 76,  127 => 75,  122 => 74,  118 => 72,  116 => 71,  110 => 70,  105 => 69,  101 => 67,  90 => 65,  85 => 64,  81 => 62,  70 => 60,  66 => 59,  61 => 58,  58 => 57,  56 => 56,  53 => 55,  51 => 52,  50 => 50,  48 => 46,  47 => 45,  46 => 44,  45 => 43,  44 => 41,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "themes/custom/dreamland/templates/field/field--commerce-order--field-pdf-file-order--default.html.twig", "/var/www/vhosts/booking.dreamlanduae.com/httpdocs/web/themes/custom/dreamland/templates/field/field--commerce-order--field-pdf-file-order--default.html.twig");
    }
    ...
    public function checkSecurity()
    {
        ...
        static $functions = array("file_url" => 79);
