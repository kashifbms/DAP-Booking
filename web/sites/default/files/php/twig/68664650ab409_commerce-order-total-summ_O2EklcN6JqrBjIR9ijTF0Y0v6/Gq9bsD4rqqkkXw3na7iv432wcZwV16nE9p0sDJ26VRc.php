...
/* themes/custom/dreamland/templates/commerce-order-total-summary.html.twig */
class __TwigTemplate_5dcccd37bc85b16f0ea812dee0244c5c extends Template
{
...
<div";
  ...
  ";
      ...
      <span class=\"order-total-line-label\">";
            ...
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (($this->extensions['Twig\Extension\CoreExtension']->formatNumber($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["totals"] ?? null), "subtotal", [], "any", false, false, true, 25), "getNumber", [], "any", false, false, true, 25), 25, $this->source), 2, ".", "") . " ") . $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["totals"] ?? null), "subtotal", [], "any", false, false, true, 25), "currencyCode", [], "any", false, false, true, 25), 25, $this->source)), "html", null, true);
            yield "</span>
    </div>
  ";
        }
  ...
  ";
      ...
      <span class=\"order-total-line-label\">";
            ...
            yield " </span><span class=\"order-total-line-value\">";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (($this->extensions['Twig\Extension\CoreExtension']->formatNumber($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["totals"] ?? null), "total", [], "any", false, false, true, 35), "getNumber", [], "any", false, false, true, 35), 35, $this->source), 2, ".", "") . " ") . $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["totals"] ?? null), "total", [], "any", false, false, true, 35), "currencyCode", [], "any", false, false, true, 35), 35, $this->source)), "html", null, true);
            yield "</span>
    </div>
  ";
        }
...
";
    ...
    {
        return "themes/custom/dreamland/templates/commerce-order-total-summary.html.twig";
    }
    ...
    {
        return new Source("", "themes/custom/dreamland/templates/commerce-order-total-summary.html.twig", "/var/www/vhosts/booking.dreamlanduae.com/httpdocs/web/themes/custom/dreamland/templates/commerce-order-total-summary.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("if" => 23, "for" => 28);
        static $filters = array("escape" => 21, "t" => 25, "number_format" => 25, "clean_class" => 29, "commerce_price_format" => 30);
        static $functions = array("attach_library" => 21);

        try {
            $this->sandbox->checkSecurity(
                ['if', 'for'],
                ['escape', 't', 'number_format', 'clean_class', 'commerce_price_format'],
                ['attach_library'],
                $this->source
            );
